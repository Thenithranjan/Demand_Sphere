...
def get_personalized_recommendations(db: Session, customer_id: str, top_n: int = 10) -> Dict[str, Any]:
    ...
    if not purchased_pids:
        ...
        c2i = rec_model["collab_index_maps"]["customer_to_idx"]
        i2p = rec_model["collab_index_maps"]["idx_to_product"]
        p2i = rec_model["collab_index_maps"]["product_to_idx"]

        c_sim = rec_model["content_similarity_matrix"]
        c_p2i = rec_model["product_index_map"]["product_id_to_index"]
        c_i2p = rec_model["product_index_map"]["index_to_product_id"]
        ...
        if customer_id in c2i:
            ...
            if len(purchased_indices) > 0:
                ...
                collab_dict = {
                    ...
                    for idx in top_collab_indices if collab_scores[idx] > 0
                }
                ...
                purchased_content_indices = [c_p2i[i2p[idx]] for idx in purchased_indices if i2p[idx] in c_p2i]
                ...
                content_dict = {
                    ...
                    for idx in top_content_indices if content_scores[idx] > 0
                }
